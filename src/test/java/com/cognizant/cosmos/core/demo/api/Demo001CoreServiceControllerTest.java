...
import com.cognizant.cosmos.core.demo.api.controller.Demo001CoreServiceController;
...
@WebMvcTest(Demo001CoreServiceController.class)
@PropertySource("classpath:log.messages")
public class Demo001CoreServiceControllerTest {

  @Autowired private MockMvc mockMvc;
  @MockBean private Demo001CoreService demo001CoreService;
  ...
  public void testGetTransferFrequencies() throws Exception {
    Mockito.when(
            demo001CoreService.getTransferFrequencies(Mockito.any(ServiceRequestContext.class)))
  ...
  public void testGetTransferProfiles() throws Exception {
    Mockito.when(demo001CoreService.getTransferProfiles(Mockito.any(ServiceRequestContext.class)))
  ...
  public void testGetTransferTypes() throws Exception {
    Mockito.when(demo001CoreService.getTransferTypes(Mockito.any(ServiceRequestContext.class)))
