package com.cognizant.cosmos.composite.demo.api.exception;
...
@ControllerAdvice
public class Demo001CompositeServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG =
      LoggerFactory.getLogger(Demo001CompositeServiceExceptionHandler.class);
