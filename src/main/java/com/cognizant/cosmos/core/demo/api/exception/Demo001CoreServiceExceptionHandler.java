...
@ControllerAdvice
public class Demo001CoreServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG =
      LoggerFactory.getLogger(Demo001CoreServiceExceptionHandler.class);
