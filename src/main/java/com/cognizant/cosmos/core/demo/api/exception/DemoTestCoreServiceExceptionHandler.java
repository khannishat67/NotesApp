package com.cognizant.cosmos.core.demo.api.exception;
...
@ControllerAdvice
public class DemoTestCoreServiceExceptionHandler extends ResponseEntityExceptionHandler {
  private static final Logger LOG =
      LoggerFactory.getLogger(DemoTestCoreServiceExceptionHandler.class);
